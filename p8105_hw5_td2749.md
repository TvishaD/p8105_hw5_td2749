...
proportional relationship between effect size and power. Given the set
sample size of 30 with 5000 trials, it is clear that the greater the
effect size, the higher the power. \_\_\_
...
every mu. It only begins to be so as the true value of mu increases.
\_\_\_
