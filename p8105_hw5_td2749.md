...
**Raw Data Description**: The raw data consists of 52179 rows of
observations and 12 columns of variables. Each row identifies a distinct
homicide victim’s information. The variables are uid, reported_date,
victim_last, victim_first, victim_race, victim_age, victim_sex, city,
state, lat, lon, disposition. From these pieces of information, we get a
