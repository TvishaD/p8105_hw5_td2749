  ...
  mutate(total = fail_to_reject + reject,
    ...
    ggplot(aes(x = as.factor(mu), y = reject_prop)) + 
      ...
      theme(plot.title = element_text(hjust = 0.5, face = "bold"),
            ...
            axis.title = element_text(face = "bold"))
```
**Association between effect size and power**: As the effect size increases, the power also increases. i.e there is a directly proportional relationship between effect size and power. In this particular case, in our t-tests, we consider the following hypothesis: 
* Ho : True mean is 0
